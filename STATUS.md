...
**Alembic head:** 047 (verified live 2026-07-10 per DEC-129)
**Latest DEC:** DEC-132 (Tier A diagnostic families promoted to prod, GATE D, 2026-07-08)
...
2. **Adding new complaint cards** — Tier A per Bryan's proposal (Cards #20 Under-Airflow, #22 Latent Deficit, #23 Thermostat, #24 Oversizing + Airflow Assessment sub-flow + Comfort Complaint tab J + superheat/subcool discrimination on Card #8). Tier A diagnostic families (comfort/airflow/not_cooling/HEB) BUILT + promoted to PROD 2026-07-08 (DEC-132, GATE D); remaining: new-card estimate pricing (business input). Card #21 PERMANENTLY EXCLUDED per Alfred. Owner: Shoab + Bryan.
...
- **2026-07-08:** DEC-132 - Tier A diagnostic families (comfort/airflow/not_cooling/HEB) promoted to PROD (GATE D); prod Alembic head now 047 (verified live 2026-07-10).
...
Last modified: 2026-07-10 by Cowork session (weekly brain audit: Alembic 034->047 correction + DEC-132 sync)
