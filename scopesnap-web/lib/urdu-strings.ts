...
export const URDU_STRINGS: Record<string, string> = {
  ...
  // ── Dashboard page ──────────────────────────────────────────────────────────────
  "Ready for your next job?":        "اگلی جاب کے لیے تیار ہیں؟",
  "Start a new assessment":          "نئی تشخیص شروع کریں",
  "90 seconds · AI-powered · Good / Better / Best": "۹۰ سیکنڈ · AI-تقویت یافتہ · اچھا / بہتر / بہترین",
  "Assess":                          "تشخیص کریں",
  "Recent Assessments":              "حالیہ تشخیصات",
  "View all →":                      "سب دیںیں →",
  "Loading assessments…":            "تشخیصات لوڈ ہو رہی ہیں…",
  "Close Rate":                      "کام بند کرنے کی شرح",
  "Avg Ticket":                      "اوسط ٹکٹ",
  "Customer":                        "گاہک",
  ...
  "good":                            "اچھا",
  "excellent":                       "بہترین",
  // Estimate tier labels (context-aware, Stage 0 v1.2) — placeholders pending native review (TODO-URDU-REVIEW)
  "tier_young_good":                 "مرمت",
  "tier_young_better":               "بہتر مرمت",
  "tier_young_best":                 "نظام کی اپ گریڈیشن",
  "tier_midlife_good":               "فوری حل",
  "tier_midlife_better":             "ذہین مرمت",
  "tier_midlife_best":               "نظام تبدیل کریں",
  "tier_eol_good":                   "عارضی حل",
  "tier_eol_better":                 "جلد تبدیل کریں",
  "tier_eol_best":                   "ابھی تبدیل کریں",
  "Fair":                            "معمولی",
  "Poor":                            "خراب",
  "Excellent":                       "بہترین",
  "Selected":                        "منتخب",
  ...
  "We typically respond within 2 hours during business hours.": "ہم عام طور پر کاروباری اوقات میں ۲ گھنٹے میں جواب دیتے ہیں۔",
  "Questions? We're here to help.":  "سوالات؟ ہم مدد کے لیے حاضر ہیں۔",
  "Call":                            "کال کریں",
  "Text":                            "میسج کریں",
  "Peak season service rate applied.": "پیک سیزن سروس ریٹ لاگو ہے۔",
  "Print":                           "پرنٹ",

  // ── Step Zero (assess/page.tsx) ──────────────────────────────────────────────────
  "STEP ZERO":                       "مرحلہ صفر",
  "Step Zero":                        "مرحلہ صفر",
  "Every Call":                      "ہر کال",
  "Nameplate Photo — Before Any Complaint": "نیم پلیٹ فوٹو — کسی شکایت سے پہلے",
  "Scan Nameplate":                  "نیم پلیٹ اسکین کریں",
  "I'll enter manually":             "میں خود درج کروں گا",
  "Indoor":                          "اندرونی",
  "Outdoor":                         "بیرونی",
};
