...
NOTE: Data was applied directly via Supabase MCP on 2026-05-19 because the
original migration file had Python syntax errors (unescaped em-dashes and
double-quotes in string literals). alembic_version was manually advanced to
021 after direct application. This rewrite is the idempotent version safe to
run on a fresh DB.
"""
import json
...
_FIELDS = ["description_good", "why_recommended_good", "description_best_comprehensive", "why_recommended_best_comprehensive", "description_best_replacement", "why_recommended_best_replacement"]
...
_CARDS = {
    "1": {
        ...
        "why_recommended_best_comprehensive": "Pitting visible on the contactor + capacitor failure together = the entire electrical circuit is fatigued. One visit clears all of it. Highest-reliability option for the next 3",
        ...
        "why_recommended_best_replacement": "Capacitor failure on a 8+ year unit signals the rest of the electrical and refrigerant circuits are nearing end-of-life. Replacement now beats $200-500 yearly repairs through year"
    },
    "2": {
        ...
        "why_recommended_best_comprehensive": "Diagnostic flagged the filter PLUS coil discoloration or drain biological growth. Addressing all three in one visit costs less than three separate service calls and resets the",
        "description_best_replacement": "At [N] years old, complete system replacement eliminates near-term repair risk and reduces electricity costs by 30-40%. New 10-year manufacturer warranty included.",
        "why_recommended_best_replacement": "Filter-related issues on an 8+ year unit usually mean the indoor coil has been running dirty for years, reducing efficiency by 15-25%. Replacement recovers that efficiency"
    },
    "3": {
    ...
    "4": {
        ...
        "why_recommended_best_comprehensive": "Tech noted bearing noise OR uneven airflow during diagnostic. ECM upgrade fixes both, plus delivers measurable bill savings. Best value when the system itself is otherwise in good",
        "description_best_replacement": "At [N] years old, complete system replacement eliminates near-term repair risk and reduces electricity costs by 30-40%. New 10-year manufacturer warranty included.",
        "why_recommended_best_replacement": "Blower motor on 8+ year unit shows the air handler is at end-of-life. Outdoor unit is likely similar age. Replacing both as a matched set restores efficiency and warranty across"
    },
    "5": {
        ...
        "why_recommended_good": "This is the first drain clog this assessment cycle. Simple flush works. The algaecide tablet handles biological regrowth for the next season. No need for the safety switch on a",
        ...
        "why_recommended_best_comprehensive": "Recurring drain clogs (2+ in 12 months) signal a deeper problem - corroded P-trap, dirty coil, or attic-mount slope issue. Rebuilding the system once costs less than three",
        "description_best_replacement": "At [N] years old, complete system replacement eliminates near-term repair risk and reduces electricity costs by 30-40%. New 10-year manufacturer warranty included.",
    ...
    "6": {
        ...
        "why_recommended_best_comprehensive": "Multiple stressed terminals + visible heat damage at the panel = the entire electrical chassis is at risk. Full overhaul is more expensive but ends the failure cycle for the life",
        "description_best_replacement": "At [N] years old, complete system replacement eliminates near-term repair risk and reduces electricity costs by 30-40%. New 10-year manufacturer warranty included.",
        "why_recommended_best_replacement": "Widespread wiring damage on an 8+ year unit means the electrical chassis is approaching end-of-life across all components. Replacement gives you new wiring, new warranty, fresh"
    },
    "7": {
        ...
        "why_recommended_best_comprehensive": "Board failure plus an old thermostat plus zoning means three integration points at risk. Upgrading them together restores compatibility for the long term and unlocks",
        "description_best_replacement": "At [N] years old, complete system replacement eliminates near-term repair risk and reduces electricity costs by 30-40%. New 10-year manufacturer warranty included.",
        "why_recommended_best_replacement": "Control board failure on an 8+ year unit indicates outdated electronics across the system. New equipment ships with modern boards, full warranty, and current communication"
    },
    "8": {
        ...
        "why_recommended_best_comprehensive": "Multiple findings (TXV corrosion + line wear + biological growth in drain) point to refrigerant circuit aging. Comprehensive service resets the circuit so future leaks are easy to",
        "description_best_replacement": "At [N] years old, complete system replacement eliminates near-term repair risk and reduces electricity costs by 30-40%. New 10-year manufacturer warranty included.",
        "why_recommended_best_replacement": "Refrigerant leak on a 10+ year R-22 unit (R-22 has been phased out, costs $150+/lb). Replacement to R-410A or R-454B eliminates the cost-of-recharge problem entirely. Mandatory by"
    },
    "9": {
        ...
        "why_recommended_best_comprehensive": "Diagnostic flagged filter + coil fouling + low charge together = the entire indoor heat-transfer path is degraded. Comprehensive reset restores design efficiency for the rest of",
        "description_best_replacement": "At [N] years old, complete system replacement eliminates near-term repair risk and reduces electricity costs by 30-40%. New 10-year manufacturer warranty included.",
        "why_recommended_best_replacement": "Repeated coil freezes on a 10+ year unit signal compressor wear, evaporator restriction, or both. Replacement avoids the cascade of $400-800 repair calls that typically follow a"
    },
    "10": {
        ...
        "why_recommended_good": "Under-warranty unit (compressor covered). Standard swap with new dryer. Do not pay for combo upgrades or replacement when manufacturer covers the part.",
        ...
        "why_recommended_best_comprehensive": "Compressor failure on a younger unit (under 8 years) where AI confirms multiple refrigerant-circuit findings. Comprehensive rebuild costs less than full replacement and preserves",
        ...
        "why_recommended_best_replacement": "Compressor failure on an 8+ year unit is the industry-standard trigger for full system replacement. The remaining components are aging on the same clock. Replacement now stops the"
    },
    "11": {
        ...
        "why_recommended_best_comprehensive": "Multiple combustion findings (dirty burners + cracked heat exchanger risk + uneven flame) indicate the entire combustion side needs attention. One-visit comprehensive service",
        "description_best_replacement": "At [N] years old, full system replacement eliminates near-term repair risk and reduces electricity costs by 30-40%. New 10-year manufacturer warranty included.",
        "why_recommended_best_replacement": "Heat exchanger cracks or repeated combustion failures on a 10+ year furnace are CO safety issues. Replacement is the only path that fully eliminates the carbon-monoxide risk for"
    },
    "12": {
        ...
        "why_recommended_best_comprehensive": "Reversing valve + defrost board issues + uneven supplemental heat = the entire heat-pump system needs review. One-visit comprehensive tune-up restores full operation for both",
        "description_best_replacement": "At [N] years old, full system replacement eliminates near-term repair risk and reduces electricity costs by 30-40%. New 10-year manufacturer warranty included.",
        "why_recommended_best_replacement": "Reversing valve failure on a 10+ year heat pump suggests the entire refrigerant circuit is aging. Replacement with a modern variable-speed heat pump unlocks 25-35% additional"
    },
    "13": {
        ...
        "why_recommended_best_comprehensive": "Attic ductwork is undersized, corroded, OR insulation is compromised. Full zone rebuild costs more upfront but delivers measurable airflow + bill savings every month for the life",
        ...
        "why_recommended_best_replacement": "Ductwork age matches HVAC age. Old leaky ducts on a tired unit means you are paying double to cool the attic. Coordinated replacement (system + ducts) is the maximum-savings"
    },
    "14": {
        ...
        "why_recommended_best_comprehensive": "Both coils fouled + bent fins + low charge = the heat-transfer surfaces are at end-of-effectiveness. Full restoration is the last service that meaningfully improves performance",
        "description_best_replacement": "At [N] years old, full system replacement eliminates near-term repair risk and reduces electricity costs by 30-40%. New 10-year manufacturer warranty included.",
        "why_recommended_best_replacement": "Severe coil fouling + 10+ year age = corrosion is irreversible at the fin level. Cleaning recovers 60-70% of original capacity at best. Replacement recovers 100% and adds modern"
    },
    "15": {
        ...
        "description_best_replacement": "At [N] years old, full system replacement eliminates near-term repair risk and reduces electricity costs by 30-40%. New 10-year manufacturer warranty included.",
        "why_recommended_best_replacement": "Piston mismatch + 10+ year age + R-22 phase-out = converting to modern refrigerant + matched components is more cost-effective than spot fixes. Mandatory by EPA refrigerant"
    },
    "16": {
        ...
        "why_recommended_best_comprehensive": "Multiple heat-damaged terminals + corrosion on connections + worn lugs = the electrical chassis itself is fatigued. Full rework is more expensive but the only path to long-term",
        "description_best_replacement": "At [N] years old, full system replacement eliminates near-term repair risk and reduces electricity costs by 30-40%. New 10-year manufacturer warranty included.",
    ...
    "17": {
        ...
        "why_recommended_best_comprehensive": "Overcharge plus TXV hunting plus inconsistent superheat readings = the refrigerant circuit needs a clean reset. Full recovery and reweighed charge restores factory performance",
        "description_best_replacement": "At [N] years old, full system replacement eliminates near-term repair risk and reduces electricity costs by 30-40%. New 10-year manufacturer warranty included.",
    ...
    "18": {
        ...
        "why_recommended_best_replacement": "Undersized systems run constantly during peak heat, dramatically reducing component life and driving 40-60% higher cooling bills. Right-sized replacement is the only fix - and the"
    },
    "19": {
        "description_good": "Replace the corroded evaporator coil. Standard repair for formicary corrosion - coatings do not prevent it long term.",
        "why_recommended_good": "Tier A is unusual for formicary - typically Better or Best wins. If Good is recommended, it is because the coil is the only finding AND the indoor air conditions cannot be",
        ...
        "why_recommended_best_comprehensive": "Formicary on a younger unit with high VOC indoor air. Coil-only replacement guarantees recurrence. Pairing with ventilation upgrade addresses the root cause and protects the new",
        "description_best_replacement": "At [N] years old, full system replacement eliminates near-term repair risk and reduces electricity costs by 30-40%. New 10-year manufacturer warranty included.",
        "why_recommended_best_replacement": "Formicary on an 8+ year unit + aged outdoor unit = the entire refrigerant circuit is at end-of-life. Replacement with a modern micro-channel coil resistant to formicary is the"
    }
}


def upgrade():
    for card_id, data in _CARDS.items():
        patches = {f: data[f] for f in _FIELDS}
        j = json.dumps(patches, ensure_ascii=False)
        sql_val = j.replace("'", "''")
        op.execute(
            "UPDATE fault_cards "
...
def downgrade():
    for field in _FIELDS:
        op.execute(
            "UPDATE fault_cards SET better_option_estimate = "
            "better_option_estimate - '" + field + "' WHERE card_id BETWEEN 1 AND 19"
        )
