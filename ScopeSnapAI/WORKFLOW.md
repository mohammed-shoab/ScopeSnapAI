...
> Last updated: 2026-05-24 — DEC-070 ACTIVE as of Stage 7 sign-off (2026-05-24). Verified end-to-end in Stage 7 Staging QA.
>
...
This workflow is **ACTIVE and mandatory** as of Stage 7 sign-off (2026-05-24). All preconditions met:
...
- ~~Stage 7 E2E QA~~ — RESOLVED Stage 7 (2026-05-24): Houston full flow PASS, PK backend PASS, DEC-070 declared ACTIVE

This document is now the single source of truth for all change operations. AI session bootstrap commit: `docs(stage-7): DEC-070 ACTIVE — staging-first workflow canonical 2026-05-24`.

Note: DEC-004 (git from `/tmp` clone), DEC-013 (no git stash from sandbox), DEC-022 (Desktop Commander for git ops) remain in force as environment constraints — these are how we physically operate git, not workflow gates.
